...
export const boostService = {
    ...
    /**
     * Mark a boost request as paid.
     * Does NOT activate - admin approval still needed.
     */
    markRequestPaid: async (requestId: string, paymentId: string): Promise<void> => {
        await api.put(`/boost/request/${requestId}/pay?payment_id=${paymentId}`);
    },
