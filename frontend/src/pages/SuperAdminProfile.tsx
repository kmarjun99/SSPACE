...
import { LogOut, User as UserIcon, Settings, HelpCircle, Shield, Trash2, Database, RefreshCw, CheckCircle } from 'lucide-react';
...
export const SuperAdminProfile: React.FC<SuperAdminProfileProps> = ({ user, onLogout }) => {
