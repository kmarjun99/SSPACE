...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ state }) => {
    ...
    const myAccommodations = state.accommodations.filter(a => a.ownerId === state.currentUser?.id);
    ...
    const getVerificationBadge = (status: string, isVerified: boolean, trustStatus?: string, entityId?: string) => {
        ...
        // Listing status
        if (status === ListingStatus.LIVE && isVerified) {
            return (
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <Badge variant={isSevere ? 'danger' : 'warning'}>
                                                {flag.entity_name}
                                            </Badge>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            <Link to="/admin/venue">
                                                <Button size="sm" variant={isSevere ? 'danger' : 'warning'}>
                ...
                hasVenue && myRoom && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        <div className="flex items-center justify-between border-b border-gray-200 pb-2">
                            ...
                            <Link to="/admin/venue">
                                <Button variant="ghost" size="sm">Manage Venue</Button>
                            </Link>
                        </div>
