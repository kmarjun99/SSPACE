...
import { Building2, MapPin, Phone, Plus, Grid, Edit2, Save, Image as ImageIcon, CheckCircle, Upload, Layers, ArrowRight, Wallet, Check, AlertCircle, Lock, Sparkles, AlertOctagon, ArrowLeft, Eye } from 'lucide-react';
    ...
    useEffect(() => {
        ...
        const fetchTrustStatus = async () => {
            ...
            try {
                ...
                // Venue may not have trust status yet (new column)
    ...
    const handleConfirmPayment = async () => {
        ...
        try {
            if (venue?.id) {
                ...
                // Refresh local state ideally, or wait for App refresh
                setTimeout(() => window.location.reload(), 1000); // Simple refresh to fetch new status
            }
        } catch (error) {
            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2">
                        ...
                        {/* Details Editor (Visible continuously for easy edits in dashboard) */}
                        <div className="mb-6">
                        ...
                        {/* Cabin Management - Dashboard Mode */}
                        {renderCabinsGrid()}
                    </div>
